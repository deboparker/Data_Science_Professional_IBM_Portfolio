...
| # | Course Name + Projects ( the hyperlink) | Status | Tools & Topics | Any Projects? Yes/No + # Projects|
|---|--------|--------|-----------------|--------|
...
| 03 | [Data Science Methodology](./03-Data-Science-Methodology) | 🟡 In Progress | CRISP-DM methodology, business understanding, analytic approach, data requirements, decision tree classification | YES/ 2|
